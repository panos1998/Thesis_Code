...
from sklearn.ensemble import ExtraTreesClassifier,ExtraTreesRegressor, StackingClassifier
...
imputer = IterativeImputer(estimator=xtr, min_value=[0 for _ in range(10)])
...
coeffs.to_csv('principal_components_reduced_rf_imp.csv')
df.describe().to_csv('stats_reduced_rf_imp.csv')
#%%
